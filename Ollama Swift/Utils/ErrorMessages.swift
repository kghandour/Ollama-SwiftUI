...
func unreachableError(error: Error?) -> ErrorModel{
    return ErrorModel(showError: true, errorTitle: "Server is unreachable", errorMessage: "Try to open ollama and continue \(String(describing: error?.localizedDescription)))")
}
